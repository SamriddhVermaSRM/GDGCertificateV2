...
var T = Xf.exports;
const og = Wm(T),
	sg = $m({ __proto__: null, default: og }, [T]);
/**
 * @license React
...
function Is(e, t) {
	...
	t.hasOwnProperty('value')
		? zs(e, t.type, n)
		: t.hasOwnProperty('defaultValue') && zs(e, t.type, jt(t.defaultValue)),
		t.checked == null &&
...
function Eg(e, t, n, r, i, o, s, l, a) {
	(yr = !1), ($i = null), Cg.apply(kg, arguments);
}
...
function ra(e, t, n, r) {
	if (Gi) {
		...
		else if ((Mu(e, r), t & 4 && -1 < Bg.indexOf(e))) {
			for (; i !== null; ) {
				var o = Jr(i);
				if (
					(o !== null && _d(o),
...
function Kd(e) {
	if (e.propertyName === 'value' && Co(Nr)) {
		var t = [];
		Wd(t, Nr, e, bl(e)), Cd(vy, t);
	}
}
function Sy(e, t, n) {
	e === 'focusin'
		? (Bu(), (wr = t), (Nr = n), wr.attachEvent('onpropertychange', Kd))
		: e === 'focusout' && Bu();
}
function xy(e) {
...
var Ye = typeof Object.is == 'function' ? Object.is : Cy;
function jr(e, t) {
	if (Ye(e, t)) return !0;
...
Bt(Zd, 'onAnimationIteration');
Bt(qd, 'onAnimationStart');
Bt('dblclick', 'onDoubleClick');
Bt('focusin', 'onFocus');
Bt('focusout', 'onBlur');
Bt(Jd, 'onTransitionEnd');
			...
			C &&
				(Bd &&
					...
					(vn || C !== 'onCompositionStart'
						? C === 'onCompositionEnd' && vn && (A = zd())
						: ((Ct = c),
						  (ia = 'value' in Ct ? Ct.value : Ct.textContent),
						  (vn = !0))),
				(E = Yi(u, C)),
				0 < E.length &&
					((C = new Nu(C, e, null, n, c)),
					f.push({ event: C, listeners: E }),
					A ? (C.data = A) : ((A = $d(n)), A !== null && (C.data = A)))),
				(A = py ? my(e, n) : gy(e, n)) &&
...
function ca(e) {
	for (; e === Ji; )
		(Ji = Tn[--Cn]), (Tn[Cn] = null), (bi = Tn[--Cn]), (Tn[Cn] = null);
	for (; e === an; )
		(an = je[--Fe]),
			(je[Fe] = null),
			(ot = je[--Fe]),
...
function lh(e) {
	...
	function y(p, h, m, w) {
		for (
			var x = null, E = null, A = h, C = (h = 0), j = null;
			A !== null && C < m.length;
			C++
		) {
			A.index > C ? ((j = A), (A = null)) : (j = A.sibling);
			var V = d(p, A, m[C], w);
			if (V === null) {
				A === null && (A = j);
				break;
		...
		if (C === m.length) return n(p, A), $ && Yt(p, C), x;
		if (A === null) {
			for (; C < m.length; C++)
				(A = f(p, m[C], w)),
					A !== null &&
						((h = o(A, h, C)), E === null ? (x = A) : (E.sibling = A), (E = A));
			return $ && Yt(p, C), x;
		}
		for (A = r(p, A); C < m.length; C++)
			(j = g(A, p, C, m[C], w)),
				j !== null &&
					(e && j.alternate !== null && A.delete(j.key === null ? C : j.key),
					(h = o(j, h, C)),
	...
	function v(p, h, m, w) {
		...
		for (
			var E = (x = null), A = h, C = (h = 0), j = null, V = m.next();
			A !== null && !V.done;
			C++, V = m.next()
		) {
			A.index > C ? ((j = A), (A = null)) : (j = A.sibling);
		...
		if (V.done) return n(p, A), $ && Yt(p, C), x;
		if (A === null) {
			for (; !V.done; C++, V = m.next())
				(V = f(p, V.value, w)),
					V !== null &&
						((h = o(V, h, C)), E === null ? (x = V) : (E.sibling = V), (E = V));
			return $ && Yt(p, C), x;
		}
		for (A = r(p, A); !V.done; C++, V = m.next())
			(V = g(A, p, C, V.value, w)),
				V !== null &&
					(e && V.alternate !== null && A.delete(V.key === null ? C : V.key),
					(h = o(V, h, C)),
					E === null ? (x = V) : (E.sibling = V),
					(E = V));
		return (
...
function ya(e, t) {
	switch ((z(Br, t), z(zr, e), z(be, br), (e = t.nodeType), e)) {
		case 9:
		case 11:
...
var oo = {
	...
	Wy = {
		...
		useTransition: function () {
			var e = rc(!1),
				t = e[0];
			return (e = By.bind(null, e[1])), (Ze().memoizedState = e), [t, e];
		},
...
function ul(e, t, n, r) {
	...
	typeof o == 'object' && o !== null
		? (i.context = ze(o))
		: ((o = Te(t) ? ln : me.current), (i.context = Un(e, o))),
	...
	switch ((ca(t), t.tag)) {
				...
				(e === null || e.child === null) &&
					(yi(t)
						...
						: e === null ||
						  ...
						  ((t.flags |= 1024), He !== null && (Tl(He), (He = null)))),
				ml(e, t),
				ce(t),
				null
			);
		...
		case 6:
			if (e && t.stateNode != null) $h(e, t, e.memoizedProps, r);
				...
				if (((n = en(Br.current)), en(be.current), yi(t))) {
					if (
						((r = t.stateNode),
						(n = t.memoizedProps),
						(r[qe] = t),
		...
		case 13:
			if (
				...
				if ($ && Re !== null && t.mode & 1 && !(t.flags & 128))
					...
					ce(t), (o = !1);
				} else He !== null && (Tl(He), (He = null)), (o = !0);
...
function Qe(e, t, n, r) {
	if (50 < Cr) throw ((Cr = 0), (xl = null), Error(P(185)));
	Zr(e, n, r),
		(!(F & 2) || e !== ie) &&
			(e === ie && (!(F & 2) && (Vo |= n), ee === 4 && Tt(e, le)),
			Ce(e, r),
...
function Yh(e, t) {
	...
	if (t !== 0) {
		if (
			...
			throw ((n = Hr), nn(e, 0), Tt(e, r), Ce(e, Z()), n);
		if (t === 6) Tt(e, r);
		else {
			if (
			...
			switch (((e.finishedWork = i), (e.finishedLanes = r), t)) {
				...
				case 3:
					if (
						(Tt(e, r), (r & 130023424) === r && ((t = Aa + 500 - Z()), 10 < t))
					) {
						if (Ki(e, 0) !== 0) break;
	...
	return Ce(e, Z()), e.callbackNode === n ? Yh.bind(null, e) : null;
}
function Pl(e, t) {
	var n = Tr;
	return (
...
function xc(e) {
	...
	if (n === 1) throw ((n = Hr), nn(e, 0), Tt(e, t), Ce(e, Z()), n);
...
function Va() {
	(ee === 0 || ee === 3 || ee === 2) && (ee = 4),
		ie === null || (!(cn & 268435455) && !(Vo & 268435455)) || Tt(ie, le);
}
function uo(e, t) {
	var n = F;
	F |= 2;
...
function bh(e, t) {
	t === 0 &&
		(e.mode & 1
			...
			: (t = 1));
	var n = ye();
	(e = pt(e, t)), e !== null && (Zr(e, t, n), Ce(e, n));
}
function lv(e) {
	var t = e.memoizedState,
		n = 0;
...
function pv(e, t, n, r, i) {
	...
	var a = _a(e, 0, !1, null, null, !1, !1, '', Cc);
	return (
	...
	switch (e.tag) {
		case 3:
			...
			if (t.current.memoizedState.isDehydrated) {
				...
				n !== 0 &&
					(ta(t, n | 1), Ce(t, Z()), !(F & 6) && ((Gn = Z() + 500), $t()));
			}
			break;
		case 13:
			fn(function () {
...
function Mv(e, t) {
	...
	return (
		...
		n
			.filter((i) => !Lc(i))
			.reduce((i, o) => i + (Cv.test(o) ? kv : o === '' ? Rv : Av), r)
	);
}
function Vv(e, t) {
...
function Dv(e, t, n) {
	...
	for (let l = 0; l < r.length; ++l) {
		...
		Object.assign(i, f.params),
			s.push({
				params: i,
				pathname: zn([o, f.pathname]),
				pathnameBase: jv(zn([o, f.pathnameBase])),
				route: d,
			}),
			f.pathnameBase !== '/' && (o = zn([o, f.pathnameBase]));
	}
	return s;
}
function Mc(e, t) {
...
const Iv = T.createContext(null),
	zv = T.createContext(null),
	hp = T.createContext(null),
	Io = T.createContext(null),
	zo = T.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
	pp = T.createContext(null);
function Oa() {
	return T.useContext(Io) != null;
}
function Bv() {
	return Oa() || ke(!1), T.useContext(Io).location;
}
function Uv(e, t) {
	return $v(e, t);
}
function $v(e, t, n, r) {
	Oa() || ke(!1);
	let { navigator: i } = T.useContext(hp),
		{ matches: o } = T.useContext(zo),
		s = o[o.length - 1],
		l = s ? s.params : {};
	s && s.pathname;
...
const Hv = T.createElement(Wv, null);
class Kv extends T.Component {
	constructor(t) {
		super(t),
			(this.state = {
				location: t.location,
...
function Gv(e) {
	...
	return (
		...
		T.createElement(zo.Provider, { value: t }, r)
	);
}
function Qv(e, t, n, r) {
	var i;
...
function Yv(e) {
	let t = T.useContext(zv);
	return t || ke(!1), t;
}
function Xv(e) {
	let t = T.useContext(zo);
	return t || ke(!1), t;
}
function Zv(e) {
	let t = Xv(),
...
function Jv(e) {
	...
	return v == null
		...
		: T.createElement(
				hp.Provider,
				{ value: u },
				T.createElement(Io.Provider, { children: n, value: v })
		  );
}
function Ia(e) {
...
function zp(e, t) {
	let n = Za(e);
	return (
		n !== Dl && (n = zt), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0
	);
}
	...
	return (
		A(0),
		{
			...
			next: (C) => {
				let j = !1;
				return (
					!E && x === void 0 && ((j = !0), w(C), A(C)),
					x !== void 0 && C >= x ? E.next(C - x) : (!j && w(C), d)
				);
			},
		}
	);
...
function mo({
	...
	const i = c1(r) ? r.map(Gc) : Gc(r),
		o = { done: !1, value: t[0] },
		s = C1(n && n.length === t.length ? n : T1(t), e),
...
const Zp = { anticipate: Pp, backInOut: xp, circInOut: Cp };
function B1(e) {
	return e in Zp;
}
class qc extends Up {
	...
	initPlayback(t, n) {
		...
		if (
			(typeof s == 'string' && go() && B1(s) && (s = Zp[s]), I1(this.options))
		) {
			const {
					onComplete: d,
					onUpdate: g,
...
function sw(e) {
	...
	function s(a) {
		...
		for (let S = 0; S < iw; S++) {
			...
			let C = A || (p === a && h.isActive && !E && w) || (S > y && w),
				j = !1;
...
function Ow() {
	const e = T.useContext(lu);
	if (e === null) return [!0, null];
	const { isPresent: t, onExitComplete: n, register: r } = e,
		i = T.useId();
	T.useEffect(() => r(i), []);
	const o = T.useCallback(() => n && n(i), [i, n]);
	return !t && n ? [!1, o] : [!0];
}
const pm = T.createContext({}),
	mm = T.createContext({}),
...
function gm(e) {
	...
	return k.jsx(Bw, {
		...e,
		layoutGroup: r,
		switchLayoutGroup: T.useContext(mm),
		isPresent: t,
		safeToRemove: n,
	});
}
				...
				e(s, () => {
					(this.root.updateBlockedByResize = !0),
						...
						zi.hasAnimatedSinceResize &&
							((zi.hasAnimatedSinceResize = !1), this.nodes.forEach(Ff));
				});
			}
		...
		applyTransformsToTarget() {
			...
			if (!(!l || !a || !u)) {
				if (
					...
					this.layout &&
					u &&
					Tm(this.options.animationType, this.layout.layoutBox, u.layoutBox)
				) {
					a = this.target || X();
		...
		getProjectionStyles(s) {
			...
			if (this.needsReset)
				return (
					(this.needsReset = !1),
					(u.opacity = ''),
					(u.pointerEvents = Bi(s == null ? void 0 : s.pointerEvents) || ''),
					...
					this.options.layoutId &&
						((v.opacity =
							this.latestValues.opacity !== void 0
								...
								: 1),
						(v.pointerEvents = Bi(s == null ? void 0 : s.pointerEvents) || '')),
					this.hasProjected &&
			...
			return (
				this.options.layoutId &&
					(u.pointerEvents =
						f === this
							? Bi(s == null ? void 0 : s.pointerEvents) || ''
							: 'none'),
				u
			);
		}
...
const vS = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
	...
	Bf = zf('applewebkit/') && !zf('chrome/') ? Math.round : pe;
function Uf(e) {
...
const xS = Pm({
	...
	PS = {
		pan: { Feature: Fw },
		drag: { Feature: jw, ProjectionNode: Cm, MeasureLayout: gm },
	};
function $f(e, t) {
...
const _S = {
	...
	NS = { layout: { ProjectionNode: Cm, MeasureLayout: gm } },
	Em = T.createContext({
	...
	Ho = T.createContext({}),
	uu = typeof window < 'u',
	jS = uu ? T.useLayoutEffect : T.useEffect,
	Rm = T.createContext({ strict: !1 });
function FS(e, t, n, r, i) {
	var o, s;
	const { visualElement: l } = T.useContext(Ho),
		a = T.useContext(Rm),
		u = T.useContext(lu),
		c = T.useContext(Em).reducedMotion,
		f = T.useRef();
	(r = r || a.renderer),
		!f.current &&
			r &&
...
function Ko(e) {
	return Bo(e.animate) || Ua.some((t) => Kr(e[t]));
}
function Lm(e) {
...
function BS(e) {
	const { initial: t, animate: n } = zS(e, T.useContext(Ho));
	return T.useMemo(() => ({ initial: t, animate: n }), [Wf(t), Wf(n)]);
}
function Wf(e) {
...
function WS({
	...
	function o(l, a) {
		let u;
		const c = { ...T.useContext(Em), ...l, layoutId: HS(l) },
			{ isStatic: f } = c,
			d = BS(l),
			g = r(l, f);
		if (!f && uu) {
...
function HS({ layoutId: e }) {
	const t = T.useContext(pm).id;
	return t && e !== void 0 ? t + '-' + e : e;
}
function KS(e, t) {
	T.useContext(Rm).strict;
}
function GS(e) {
...
let zm = (e) => !So(e);
function cx(e) {
	e && (zm = (t) => (t.startsWith('on') ? !So(t) : e(t)));
}
try {
...
class Um extends wx {
	constructor() {
		super(...arguments), (this.KeyframeResolver = Bp);
	}
...
const Tx = (e, t) =>
		cu(e) ? new Px(t) : new xx(t, { allowProjection: e !== T.Fragment }),
	Cx = px({ ...fw, ..._S, ...PS, ...NS }, Tx),
	Ke = n0(Cx);
function kx() {
	return k.jsxs(
		Ke.div,
...
function Lx() {
	...
	T.useEffect(() => {
		e
			? r(e).then((o) => {
					o ? i(o) : (window.location.href = '/error');
	...
	const r = async (o) => {
			...
			try {
				...
				const l = await s.text(),
					a = l.split('<title>')[1].split('|')[0],
					u = l.split('<a class="badge-image" href="').slice(1),
					c = u.map((g) => g.split('">')[0]),
					f = u.map((g) => g.split('src="')[1].split('"')[0]);
				return { name: a, links: { badges: c, images: f } };
			} catch (s) {
				console.error(s);
				return;
			}
		...
		i = (o) => {
			...
			window.location.href = '/certificate/view?data=' + s;
		};
